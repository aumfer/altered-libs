...
namespace Altered.Mvc
{
    public static class AspNet
    {
        ...
        public static RequestDelegate ToAspNet(this IAlteredPipeline<AlteredApiRequest, AlteredApiResponse> pipeline) =>
            async (httpContext) =>
            {
        ...
        public static RequestDelegate WithAspNet(RequestDelegate aspnet, CloudwatchLogsSink cloudwatchLogs, CloudwatchMetricsSink cloudwatchMetrics)
        {
